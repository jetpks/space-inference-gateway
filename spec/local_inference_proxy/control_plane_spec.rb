...
RSpec.describe "Model Control Plane" do
  ...
  let(:cp_status_qwen_json) do
    JSON.generate(cp_status.merge(
                    "active_model"       => "/Users/operator/.lmstudio/models/unsloth/Qwen3.6-27B-MTP-GGUF",
                    "model_identifier"   => "/Users/operator/.lmstudio/models/unsloth/Qwen3.6-27B-MTP-GGUF",
                    "is_diffusion"       => false,
                    "supports_reasoning" => true,
                    "loaded"             => ["/Users/operator/.lmstudio/models/unsloth/Qwen3.6-27B-MTP-GGUF"],
                  ))
  end
